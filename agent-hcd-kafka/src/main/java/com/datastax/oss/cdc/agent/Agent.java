...
public class Agent {
    ...
    static void startCdcAgent(String agentArgs) throws Exception {
        ...
        log.info("Starting Kafka CDC agent v{}, cdc_raw_directory={}", agentVersion, DatabaseDescriptor.getCDCLogLocation());
        ...
        CommitLogReaderServiceImpl commitLogReaderService = new CommitLogReaderServiceImpl(config, kafkaMutationSender, segmentOffsetFileWriter, commitLogTransfer);
